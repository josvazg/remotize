...
// NewService returns a new service wrapper to serve calls to 'ifaceimpl' remotelly
...
func NewServiceWith(iface interface{},
...
// NewRemote returns a reference to a remote interface of type iface,
